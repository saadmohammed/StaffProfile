...
public class NTUnAidedFragment extends Fragment {
    View view;
    private RecyclerView ntUnAidedRecyclerView;
    private LinearLayoutManager linearLayoutManager;

    private DatabaseReference ntUnAidedDatabaseReference;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.ntunaided, container, false);

        ntUnAidedRecyclerView = view.findViewById(R.id.ntunAidedRecyclerView);
        ntUnAidedRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
